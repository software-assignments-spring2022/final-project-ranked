    ...
    axios
      ...
      .catch((err) => {
        if (err) {
          ...
          alert(
            "Please login or register first before trying to submit a thread request!"
          )
        }
      })
  }
    ...
    <>
      <main className="ThreadRequest">
        <div className="ThreadRequest-div">
          <p>
            <b>Requesting a New Game Thread</b>
          </p>
          <Form onSubmit={HandleThreadRequest}>
            <div className="ThreadRequest-gameNameTextAreaDiv">
              <Form.Group>
                ...
                <Form.Control
                  className="ThreadRequest-gameNameTextArea"
                  as="textarea"
                  rows={1}
                  value={gameName}
            ...
            <div className="ThreadRequest-questionDiv">
              <p className="ThreadRequest-questonP">
                1. Do you want to be the moderator of this game thread?
              </p>
            ...
            <div className="ThreadRequest-textAreaDiv">
              <Form.Group>
                ...
                <Form.Control
                  className="ThreadRequest-textArea"
                  as="textarea"
                  rows={9}
                  value={reason}
